...
export const zh = {
  ...
  'panel.credential.title': '凭据',
  'panel.credential.source': '凭据来源:credentials 服务,后备 .env 的 DASHSCOPE_API_KEY',
...
export const en = {
  ...
  'panel.credential.title': 'Credentials',
  'panel.credential.source': 'Source: credentials service, falling back to .env DASHSCOPE_API_KEY',
