...
根 `README.md` 负责项目入口和最短使用路径；`docs/README.md` 负责完整文档导航、分类说明与维护规则。各包 README 只说明对应包的安装、公开接口和限制，不复制整套产品文档。对外文档的中英文范围、镜像路径和维护规则见[对外文档双语治理](bilingual-public-documentation.md)。
...
9. 面向 GitHub、npm 使用者与外部集成开发者的文档，按[对外文档双语治理](bilingual-public-documentation.md)在同一提交同步维护中英文版本；内部测试、计划和原始制品不纳入公开翻译范围。
